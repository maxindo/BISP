...
- **Halaman Isolir**: https://cvlmedia.my.id/isolir
...
```bash
# Cek DNS static
/ip dns static print where name~"cvlmedia.my.id"
...
```bash
# Hapus DNS static
/ip dns static remove [find where name~"cvlmedia.my.id"]
...
### **2. Domain**
- Ganti `cvlmedia.my.id` dengan domain Anda
